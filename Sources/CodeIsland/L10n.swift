...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "shortcut_deny": "Deny",
        "auto_approve_60s": "Auto 60s",
        "auto_approve_on": "Auto-approve ON (click to disable)",
        "auto_approve_off": "Auto-approve OFF (click to enable)",
    ...
    private static let zh: [String: String] = [
        ...
        "auto_approve_60s": "60秒自动同意",
        "auto_approve_on": "自动同意已开启（点击关闭）",
        "auto_approve_off": "自动同意已关闭（点击开启）",
